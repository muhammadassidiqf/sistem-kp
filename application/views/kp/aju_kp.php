    ...
    <div id="content">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-9 mb-4">
                ...
                <div class="form-row">
                    <div class="col-lg-7">
                        <input type="tujuan" placeholder="Tujuan Surat" class="form-control my-3 p-4">
                    </div>
                </div>

                <div class="form-row">
                    <div class="col-lg-7">
                        <input type="penugasan" placeholder="Penugasan KP" class="form-control my-3 p-4">
                    </div>
                </div>

                <div class="form-row">
                    <div class="col-lg-7">
                        <input type="wali dosen" placeholder="Wali Dosen" class="form-control my-3 p-4">
                    </div>
                </div>

                <div class="form-row">
                    <div class="col-lg-7">
                        <input type="date" placeholder="Tanggal Pengajuan" class="form-control my-3 p-4">
                    </div>
                </div>
