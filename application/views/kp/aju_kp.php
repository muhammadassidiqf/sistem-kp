            ...
            <div class="col-lg-9 mb-4">
                <form action="<?= site_url('pengajuan_kp') ?>" method="post">
                    <div class="form-row">
                        ...
                        <div class="col-lg-7">
                            <select type="text" name="perusahaan" id="pers" placeholder="Nama Perusahaan" class="form-control my-3 p-4" required>
                        ...
                        <div class="col-lg-7">
                            ...
                            <select type="text" name="dosen" id="dsn" placeholder="Nama Dosen" class="form-control my-3 p-4">
