    ...
    <div id="content">
        ...
        <div class="row  mb-4">
            ...
            <div class="col-lg-12 justify-content-center mb-4">
                ...
                <div class="form-row">
                    <div class="col-lg-7">
                        <input type="text" name="email" value="<?= $prof['email'] ?>" class="form-control my-0 p-4" readonly>
                    </div>
                </div>
                <label for="no-telp" class="col-sm-2 col-form-label">No Handphone</label>
                <div class="form-row">
                    <div class="col-lg-7">
                        <input type="text" name="no_telp" value="<?= $prof['no_telp'] ?>" class="form-control my-0 p-4" readonly>
                    </div>
                </div>
